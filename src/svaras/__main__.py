...
def main():
    ...
    trainer = Trainer(model, logger, device)
    ...
    evaluator = Evaluator(model, logger, device)
...
def parse_args():
    ...
    parser.add_argument('--catchup', type=int, default=15, help='number of epochs to freeze encoders (default: 15)')
