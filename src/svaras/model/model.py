...
from svaras.model.inception import Encoder
from svaras.model.lora import apply_lora
from svaras.model.attention import Attention

class Model(nn.Module):
    def __init__(self, embed_dim, num_classes, depth, filename, num_features=2, dropout=0.2):
        super().__init__()
    ...
    def forward(self, prec, curr, succ):
        embedding = self._encode(prec, curr, succ)
        return self.fully_connected(embedding)

    def _encode(self, prec, curr, succ):
